...
session_start();
 include('inc/dbConn.php');
  ...
  $uname = $_SESSION['uname'];
    $query = mysqli_query($conn, "SELECT * FROM carsdetail WHERE approval='approved'AND sellername = '$uname' AND deleted='no' AND buyersname='no'");
  ...
  <form method="POST">
  <button type="submit" id="delete" name="submit2" style="
  ...
  if (isset($_POST['submit2'])){
    $sql_update="UPDATE  carsdetail SET deleted = 'yes' WHERE id = '".$row['id']."'";
