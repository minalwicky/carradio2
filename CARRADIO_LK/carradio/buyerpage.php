...
<?php
 ...
 if (isset($_POST['submit6'])) {
  ...
  header('location:searchpage.php');
    ...
    $query = mysqli_query($conn, "SELECT * FROM carsdetail WHERE approval='approved' AND deleted='no' AND buyersname='no'");
  ...
  <form method="POST">
  <button type="submit" id="purchase" name="submit4" style="
